export const CATEGORY_DISPLAY: Record<string, { name: string; emoji: string; desc: string }> = {
  ...
  // Handel & Butik
  kundservice:          { name: 'Kundservice',          emoji: '🤝', desc: 'Bemötande & kundrelationer' },
  kassa_betalning:      { name: 'Kassa & betalning',    emoji: '💳', desc: 'Kassasystem & betalsätt' },
  arbetsratt:           { name: 'Arbetsrätt',           emoji: '⚖️', desc: 'Lagar, avtal & rättigheter' },
  lager_logistik:       { name: 'Lager och logistik',   emoji: '📦', desc: 'Varuflöde & lagerhållning' },
  forsaljningsteknik:   { name: 'Försäljningsteknik',   emoji: '💼', desc: 'Merförsäljning & säljpsykologi' },
  forlustforebyggande:  { name: 'Förlustförebyggande',  emoji: '🔒', desc: 'Stöldskydd & svinn' },
  detaljhandelsekonomi: { name: 'Detaljhandelsekonomi', emoji: '💰', desc: 'Marginaler, priser & lönsamhet' },
  halsa_sakerhet:       { name: 'Hälsa & Säkerhet',     emoji: '🦺', desc: 'Ergonomi & arbetsmiljö' },
  produktkunskap:       { name: 'Produktkunskap',       emoji: '🏷️', desc: 'Sortiment & varuegenskaper' },
  roligt:               { name: 'Roligt',               emoji: '😄', desc: 'Klassiska stunder från butiksgolvet' },
  // IT (IT & Software)
...
export const CATEGORY_COLORS: Record<string, string> = {
  ...
  fun_culture: '#00FF64',
  kundservice:          '#FF6B2B',
  kassa_betalning:      '#FF9A5E',
  arbetsratt:           '#FFB830',
  lager_logistik:       '#FF9A5E',
  forsaljningsteknik:   '#FF6B2B',
  forlustforebyggande:  '#FFB830',
  detaljhandelsekonomi: '#FF9A5E',
  halsa_sakerhet:       '#FF6B2B',
  produktkunskap:       '#FFB830',
  roligt:               '#FF9A5E',
}
